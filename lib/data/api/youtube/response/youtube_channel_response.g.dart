...
YoutubeStaticsResponse _$YoutubeStaticsResponseFromJson(
        Map<String, dynamic> json) =>
    YoutubeStaticsResponse(
      json['viewCount'] as String,
      json['subscriberCount'] as String,
      json['videoCount'] as String,
      json['hiddenSubscriberCount'] as bool,
    );

YoutubeChannelDetailResponse _$YoutubeChannelDetailResponseFromJson(
        Map<String, dynamic> json) =>
    YoutubeChannelDetailResponse(
      YoutubeStaticsResponse.fromJson(
